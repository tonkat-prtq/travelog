...
Route::prefix('register')
    ...
    ->group(function () {
        Route::get(
            '/{provider}',
            'Auth\RegisterController@showProviderUserRegistrationForm',
        )->name('{provider}');
        Route::post(
            '/{provider}',
            'Auth\RegisterController@registerProviderUser',
        )->name('{provider}');
    });
...
Route::prefix('users')
    ...
    ->group(function () {
        ...
        Route::get('/{name}/followings', 'UserController@followings')->name(
            'followings',
        );
        Route::get('/{name}/followers', 'UserController@followers')->name(
            'followers',
        );
        Route::middleware('auth')->group(function () {
            Route::put('/{name}/follow', 'UserController@follow')->name(
                'follow',
            );
            Route::delete('/{name}/follow', 'UserController@unfollow')->name(
                'unfollow',
            );
        });
    });
